...
LeafByte uses CocoaPods to manage dependencies (specifically for AppAuth to enable Google Sign-In), but you shouldn't have to worry about that unless you're adding a new dependency. See TECH_DEBT.md for context on the use of CocoaPods.
