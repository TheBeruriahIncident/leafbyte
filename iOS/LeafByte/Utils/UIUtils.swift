...
@available(iOS 14.0, *)
func finishWithPHPicker(self viewController: UIViewController, picker: PHPickerViewController, didFinishPicking results: [PHPickerResult], onCancel: @escaping () -> Void = {}, selectImage: @escaping (CGImage) -> Void) {
    picker.delegate = nil
