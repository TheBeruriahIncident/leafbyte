...
buildscript {
    ...
    dependencies {
        ...
        classpath("nl.littlerobots.vcu:plugin:1.1.0")
...
plugins {
    id("com.github.ben-manes.versions").version("0.54.0") // Adds dependencyUpdates command to determinate stale dependencies
